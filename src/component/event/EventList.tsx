...
export default function EventList() {
    ...
    const bg = [require('../../../images/background1.jpg'),require('../../../images/background3.jpg'),
    require('../../../images/background6.jpg'), require('../../../images/background7.jpg')]
    ...
    return <View style={{ flex: 1 }}>
        <SelectDropdown
            ...
            buttonStyle={{
                backgroundColor: cont.setting.theme.colors.background,
                width: 110, height: 30, marginVertical: 5, marginHorizontal: 10,
